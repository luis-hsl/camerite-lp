...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#1eba59] text-white p-4 rounded-2xl shadow-lg shadow-[#25D366]/20 transition-all duration-500 hover:scale-105 ${
