...
export default function AppDemo() {
  ...
  return (
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="absolute top-1/3 left-0 w-[60%] max-w-[400px] aspect-[4/3] bg-cam-purple/[0.04] blur-[100px] rounded-full pointer-events-none" />
      ...
      <div ref={sectionRef} className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-cam-purple/20 border border-white/[0.08]">
                ...
                <div className="absolute inset-x-0 bottom-0 h-28 bg-gradient-to-t from-cam-purple via-cam-purple/70 to-transparent flex items-end pb-5 px-5">
                  <p className="text-white text-sm font-medium leading-snug">
                    Abriu o app, tá vendo. De qualquer lugar.
                  </p>
                </div>
              </div>
              {/* Glow */}
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="reveal reveal-delay-2 text-base md:text-lg max-w-2xl leading-relaxed text-zinc-300 mb-10">
              Caiu um alerta? Abre o celular e já tá vendo. Quer rever o que aconteceu ontem? Tá tudo ali. Sem precisar ligar pra ninguém.
            </p>

            {/* Feature micro-list */}
            <div className="reveal reveal-delay-2 flex flex-wrap gap-x-5 gap-y-2 text-sm text-zinc-400 mb-8">
              <span className="flex items-center gap-2">
                <span className="w-1 h-1 rounded-full bg-cam-purple" />
            ...
            <div className="reveal reveal-delay-3 flex flex-wrap gap-3">
              <a
                ...
                className="group flex items-center gap-2.5 bg-white/[0.04] border border-white/[0.1] hover:border-cam-purple/30 hover:bg-cam-purple/[0.06] rounded-xl px-5 py-3 transition-all duration-300"
              >
                <svg className="w-5 h-5 text-white group-hover:text-cam-purple-soft transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="text-left">
                  <div className="text-[10px] text-zinc-400 leading-none">Disponivel no</div>
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-[10px] text-zinc-400 leading-none">Baixar na</div>
